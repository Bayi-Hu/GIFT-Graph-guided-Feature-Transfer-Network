...
from Model.DNN_GIFT import DNNGIFT
...
if __name__ == '__main__':
    ...
    model = DNNGIFT(train_tensor_dict, train_config={"is_training": True, "dropout_rate": 0.2})
    model.build()
    ...
    with tf.Session() as sess:
        ...
        # for i in range(100):
            try:
                ...
                print(e)
                # save model
                saver.save(sess, os.path.join(checkpoint_dir, "model_gift_1"))
                break